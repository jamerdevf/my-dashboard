...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  try {
    ...
    return {
      ...
      description:'Occaecat quis esse reprehenderit proident ex officia voluptate proident. Nostrud Lorem Lorem nostrud eu esse ipsum id cupidatat cupidatat commodo cupidatat aute reprehenderit. Commodo do mollit voluptate culpa nostrud.'
    } 
  }
}
